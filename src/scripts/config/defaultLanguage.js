(function () {
    ...
    angular.module('ariaNg').config(['$translateProvider', 'ariaNgConstants', function ($translateProvider, ariaNgConstants) {
        var defaultLanguageResource = {
            ...
            'Clear the same name error task': 'Clear the same name error task',
            ...
            'Do you want to clear the wrong task with the same name?': 'Do you want to clear the wrong task with the same name?',
